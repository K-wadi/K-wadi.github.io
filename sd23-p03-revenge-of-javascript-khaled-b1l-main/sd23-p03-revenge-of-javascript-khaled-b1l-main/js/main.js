...
const windSpeed = document.querySelector(".windDetails .windSpeed p");
const humidity = document.querySelector(".windDetails .humidity p");
const weather = document.querySelector(".cityDetails .weather");
const desc = document.querySelector(".cityDetails .desc");
const API = "8cf5ac5621c8d0266298a149e49d7514";

// Functie om weerinformatie in te stellen op basis van ontvangen gegevens
const setWeatherDetails = (data) => {
  desc.innerHTML = data.weather[0].description;
  weather.innerHTML = Math.round(data.main.temp - 273.15) + "°C";
  humidity.innerHTML = data.main.humidity + "%";
  windSpeed.innerHTML = data.wind.speed + "km/h";
  // Weericoon dynamisch instellen op basis van het weerstype
...
// Functie om de API aan te roepen en weerinformatie op te halen
const callAPI = (id) => {
  fetch(
...
// Eventlistener voor de zoekknop om de API aan te roepen bij klikken
...
// Eventlistener voor het invoerveld om de API aan te roepen bij Enter-toets
...
// Roep de API aan bij het laden van de pagina
searchButton.click();
