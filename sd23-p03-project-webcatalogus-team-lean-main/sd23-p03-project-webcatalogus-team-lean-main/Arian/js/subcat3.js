// Asynchrone functie die schoenen van subcategorie 3 ophaalt en weergeeft
async function fetchAndDisplayShoes() {
    try {
        // Wacht op het ophalen van de schoenen van subcategorie 3 van de server
        const response = await fetch('http://localhost:3600/api/subcat3');
