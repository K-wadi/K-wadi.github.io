// Functie om schoenen van de tweede categorie op te halen en weer te geven
async function fetchAndDisplayShoes() {
    try {
        // Haal de schoenen op van de API voor de tweede categorie
        const response = await fetch('http://localhost:3600/api/sportcat2');
