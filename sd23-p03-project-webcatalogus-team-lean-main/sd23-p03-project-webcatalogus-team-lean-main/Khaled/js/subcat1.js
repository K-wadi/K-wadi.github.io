// Functie om schoenen van de eerste categorie op te halen en weer te geven
async function fetchAndDisplayShoes() {
    try {
        // Haal de schoenen op van de API voor de eerste categorie
        const response = await fetch('http://localhost:3600/api/sportcat1');
